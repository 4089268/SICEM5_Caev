...
public partial class DetallePagosVtn
{
    [Inject]
    ...
    private SfGrid<OprVenta> DataGrid {get;set;}
    public List<OprVenta> Datos {get;set;}


    public void Show(IEnlace enlace, IEnumerable<OprVenta> datos, string titulo = ""){
